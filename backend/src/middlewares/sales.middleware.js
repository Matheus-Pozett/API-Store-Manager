const { salesSchema, updateSaleSchema } = require('../utils/joiSchemas');
...
const validateUpdateSaleProduct = (req, res, next) => {
...
module.exports = { validateNewSales, validateUpdateSaleProduct };